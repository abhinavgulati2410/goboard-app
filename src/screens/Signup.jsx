...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_BACKEND_URI}/api/auth/getlocation`, {
      method: 'POST',
      headers: {
  ...
  return (
    <div style={{ backgroundImage: 'url("https://thumbs.dreamstime.com/b/carrom-19448852.jpg")', backgroundSize: 'cover',height: '100vh' }}>
      <div>
      <Navbar />
      </div>

...
// var gamesItems= require('../index').gamesData;
// require("../index")
...
router.post('/gamesData', async (req, res) => {
    try {
        console.log(JSON.stringify(global.gamesData))
        // const userId = req.user.id;
        // await database.listCollections({name:"games_items"}).find({});
        res.send([global.gamesData, global.gamesCategory])
    } catch (error) {
        console.error(error.message)
        res.send("Server Error")
